...
foreach ($token in 'CurrentAccountMovements','CurrentAccounts','Quotes','DocumentType int','DocumentNumber bigint','BranchId int','IsVoided bit','decimal(18,2)','(1, 101','(6, ''2026-01-01'',103,20,1006','synthetic non-target','synthetic non-scoped') {
