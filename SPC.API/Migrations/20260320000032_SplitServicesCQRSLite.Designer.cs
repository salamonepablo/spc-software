...
namespace SPC.API.Migrations
{
    ...
    [Migration("20260320000032_SplitServicesCQRSLite")]
    partial class SplitServicesCQRSLite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPC.Shared.Models.Customer", b =>
                {
                    ...
                    b.Property<string>("IIBBRegistryProvince")
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("SPC.Shared.Models.Invoice", b =>
                {
                    ...
                    b.Property<decimal>("IIBBPerceptionAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("IncludedVAT")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("InvoiceType", "PointOfSale", "InvoiceNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("SPC.Shared.Models.Warehouse", b =>
                {
                    ...
                    b.Property<int?>("AssociatedSalesRepId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssociatedSalesRepId");
            ...
            modelBuilder.Entity("SPC.Shared.Models.Warehouse", b =>
                {
                    b.HasOne("SPC.Shared.Models.SalesRep", "AssociatedSalesRep")
                        .WithMany("AssignedWarehouses")
                        .HasForeignKey("AssociatedSalesRepId");

                    b.Navigation("AssociatedSalesRep");
                });
            ...
            modelBuilder.Entity("SPC.Shared.Models.SalesRep", b =>
                {
                    b.Navigation("AssignedWarehouses");
