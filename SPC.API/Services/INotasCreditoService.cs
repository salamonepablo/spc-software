...
public interface INotasCreditoService
{
    ...
    Task<IEnumerable<NotaCreditoResponse>> GetAllAsync(int skip = 0, int take = 50);
    
    /// <summary>Get credit note by ID with all details</summary>
    Task<NotaCreditoCompletaResponse?> GetByIdAsync(int id);
    
    /// <summary>Get credit notes by customer</summary>
    Task<IEnumerable<NotaCreditoResponse>> GetByCustomerAsync(int customerId);
    
    /// <summary>Get credit notes by invoice</summary>
    Task<IEnumerable<NotaCreditoResponse>> GetByInvoiceAsync(int invoiceId);
    
    /// <summary>Get credit notes by date range</summary>
    Task<IEnumerable<NotaCreditoResponse>> GetByDateRangeAsync(DateTime from, DateTime to);
    
    /// <summary>Search credit notes</summary>
    Task<IEnumerable<NotaCreditoResponse>> SearchAsync(string term);
    ...
    /// </summary>
    Task<NotaCreditoCompletaResponse> CreateAsync(CreateNotaCreditoRequest request);
